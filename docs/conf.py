...
# Note:  Recommonmark replacement: https://github.com/executablebooks/MyST-Parser

# -- Project information -----------------------------------------------------

project = 'Bee Snuggler'
copyright = '2021, Lee C. Bussy'
author = 'Lee C. Bussy'
...
html_logo = "_static/bee-icon-24x24.png"
